 ...
 *
 * Class Result_Item
 * @package CP_Defender\Module\Scan\Model
 */
class Result_Item extends Model {
	...
	public function behaviors() {
		switch ( $this->type ) {
			case 'core':
				return array(
					'coreResult' => '\CP_Defender\Module\Scan\Behavior\Core_Result',
					'utils'      => '\CP_Defender\Behavior\Utils'
				);
				break;
			case 'vuln':
				return array(
					'vulnResult' => '\CP_Defender\Module\Scan\Behavior\Pro\Vuln_Result',
					'utils'      => '\CP_Defender\Behavior\Utils'
				);
				break;
			case 'content':
				return array(
					'contentResult' => '\CP_Defender\Module\Scan\Behavior\Pro\Content_Result',
					'utils'         => '\CP_Defender\Behavior\Utils'
				);
				break;
		}
