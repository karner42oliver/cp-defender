                    ...
                    <div class="columns">
                            ...
                            <div>
                                <h5 class="">
                                    <span class="issues-actioned"><?php echo( $controller->getCount( 'fixed' ) + $controller->getCount( 'ignore' ) ) ?></span>
                                        /<?php echo count( \CP_Defender\Module\Hardener\Model\Settings::instance()->getDefinedRules( false ) ) ?>
                        ...
                        <div class="column is-5">
                            <ul class="dev-list bold">
                                <li>
                                    <div>
                                        <span class="list-label"><?php _e( "PHP Version", cp_defender()->domain ) ?></span>
