<div class="dev-box">
    <div class="box-title">
        <h3><?php _e( "IGNORED", cp_defender()->domain ) ?>
    ...
    <div class="box-content">
        <div class="box-content">
			<?php if ( count( \CP_Defender\Module\Hardener\Model\Settings::instance()->ignore ) > 0 ): ?>
                <div class="line">
					<?php _e( "You have chosen to ignore these fixes. You can restore and action them at any time.", cp_defender()->domain ) ?>
                </div>
			...
			<?php else: ?>
                <div class="well well-blue with-cap">
					...
					<?php _e( "You haven't ignored any issues yet. You can ignore any security tweaks you don't want to be warned about by clicking 'Ignore' inside the issue description.", cp_defender()->domain ) ?>
                </div>
			<?php endif; ?>
        </div>
    </div>
