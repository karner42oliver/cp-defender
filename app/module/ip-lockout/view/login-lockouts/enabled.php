<div class="dev-box">
    <form method="post" id="settings-frm" class="ip-frm">
        <div class="box-title">
            <h3><?php _e( "Login Protection", cp_defender()->domain ) ?></h3>
            <div class="side float-r">
                <div>
                    <span tooltip="<?php esc_attr_e( "Deactivate Login Protection", cp_defender()->domain ) ?>"
                          class="toggle">
        ...
        <div class="box-content">
			...
			<?php else: ?>
                <div class="well well-blue">
					<?php esc_html_e( "Login protection is enabled. There are no lockouts logged yet.", cp_defender()->domain ) ?>
                </div>
			<?php endif; ?>
            <div class="columns">
                <div class="column is-one-third">
                    ...
                    <span class="sub">
                        <?php esc_html_e( "Specify how many failed login attempts within a specific time period will trigger a lockout.", cp_defender()->domain ) ?>
						</span>
                </div>
                <div class="column">
                    ...
                    <span><?php esc_html_e( "failed logins within", cp_defender()->domain ) ?></span>&nbsp;
                    ...
                    <span><?php esc_html_e( "seconds", cp_defender()->domain ) ?></span>
                </div>
            </div>
            <div class="columns">
                <div class="column is-one-third">
                ...
                <div class="column">
                    ...
                    <label for="login_protection_lockout_ban"
                           class="inline form-help is-marginless"><?php esc_html_e( 'Permanently ban login lockouts.', cp_defender()->domain ) ?></label>
                </div>
            </div>
            ...
            <div class="columns">
                <div class="column is-one-third">
                    <label for="username_blacklist">
						<?php esc_html_e( "Automatically ban usernames", cp_defender()->domain ) ?>
                    </label>
                    <span class="sub">
                        <?php esc_html_e( "We recommend you avoid using the default username \"admin.\" Defender will automatically lock out any users who attempt to enter your site using the usernames you list here.", cp_defender()->domain ) ?>
                    </span>
                </div>
                <div class="column">
                    <textarea placeholder="<?php esc_attr_e( "Type usernames, one per line", cp_defender()->domain ) ?>"
                    ...
                    <span class="sub">
						...
						printf( __( "We recommend adding the usernames <strong>admin</strong>, <strong>administrator</strong> and your hostname <strong>%s</strong> as these are common for bots to try logging in with. One username per line", cp_defender()->domain ), $host ) ?>
                    </span>
                </div>
            </div>
