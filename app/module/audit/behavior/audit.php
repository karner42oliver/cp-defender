        ...
        <div class="dev-box">
            ...
            <div class="box-content auditing">
				<?php if ( Settings::instance()->enabled ): ?>
                    ...
                    <div class="">
						<?php __( "Please hold on, Defender will update Audit information soon...", cp_defender()->domain ) ?>
                    </div>
				...
				<?php else: ?>
                    ...
                    <form method="post" class="audit-frm active-audit">
                        ...
                        <button type="submit" class="button button-small"><?php _e( "Activate", cp_defender()->domain ) ?></button>
                    </form>
				<?php endif; ?>
            </div>
        </div>
