                        ...
                        <td colspan="4">
                            <div class="dev-box">
                                <div class="box-content">
                                            ...
                                            <td>
                                                <a class="afilter"
                                                   href="<?php echo $controller->buildFilterUrl( 'context', $row['context'] ) ?>">
													<?php echo ucwords( \CP_Defender\Module\Audit\Component\Audit_API::get_action_text( $row['context'] ) ) ?>
                                                </a>
                                            </td>
                                            <td>
                                                <a class="afilter"
                                                   href="<?php echo $controller->buildFilterUrl( 'event_type[]', $row['event_type'] ) ?>">
													<?php echo ucwords( \CP_Defender\Module\Audit\Component\Audit_API::get_action_text( $row['event_type'] ) ) ?>
                                                </a>
                                            </td>
                                            <td>
                                                <a class="afilter"
									...
									<?php if ( ! \CP_Defender\Module\IP_Lockout\Model\Settings::instance()->isBlacklist( $row['ip'] ) ): ?>
