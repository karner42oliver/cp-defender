...
use CP_Defender\Module\Advanced_Tools\Component\Auth_API;
...
class Main extends Controller {
	...
	public function includeAuthStyles() {
		//enqueue css here
		wp_enqueue_style( 'defAuth', cp_defender()->getPluginUrl() . 'app/module/advanced-tools/css/login.css' );
	}
...
return;
	...
	public function scripts() {
		if ( $this->isInPage() || $this->isDashboard() ) {
			...
			wp_enqueue_script( 'adtools', cp_defender()->getPluginUrl() . 'app/module/advanced-tools/js/scripts.js' );
		}
	}
