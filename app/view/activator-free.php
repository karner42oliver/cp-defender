<dialog id="activator">
    <div class="activate-picker">
        <div class="line end">
	        <?php _e( "Welcome to Defender! Let's quickly set up the most important security features, then you can fine tune each setting later. Our recommendations are turned on by default.", cp_defender()->domain ) ?>
        </div>
        <form method="post">
