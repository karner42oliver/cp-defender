...
namespace CP_Defender\Controller;
...
class Dashboard extends Controller {
	protected $slug = 'cp-defender';

	public function __construct() {
		// Registriere BEIDE Hooks, aber admin_menu() wird überprüfen, wo es laufen darf
	...
	public function manage_audit_log( $params, $action ) {
		$response = null;
		if ( class_exists( '\CP_Defender\Module\Audit\Model\Settings' ) ) {
			$response = array();
	...
	public function countTotalIssues( $detail = false ) {
		$hardenerCount = count( \CP_Defender\Module\Hardener\Model\Settings::instance()->issues );
	...
	public function admin_menu() {
		// Wenn netzwerkweit aktiviert und wir sind NICHT im Netzwerk-Admin, nicht registrieren
